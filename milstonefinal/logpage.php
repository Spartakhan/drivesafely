...
echo "Welcome $username, <a href='loginpage.php'>click</a> here to search for offender \n";
echo "<br>";
echo "\n<a href='delpage.php'>click</a> here to delete an offender's information";
echo "<br>";
echo "\n<a href='addinfo.php'>click</a> here to insert offender's offence";
//session part
